...
class user
{
	...
	public function login($email, $password)
	{
		...
		if ($result) {
			...
			// if ($value['status'] == 1 || $value['isConfirmed'] == 1) {
	...
	public function insert($data)
	{
		...
		if ($result_check) {
			...
			if ($result) {
				...
				$mail->Username   = "nguyenvanduong10a5hh4@gmail.com";
				$mail->Password   = "uhbdbriowcziatcb";

				$mail->IsHTML(true);
				$mail->CharSet = 'UTF-8';
				$mail->AddAddress($email, "recipient-name");
				$mail->SetFrom("nguyenvanduongit01@gmail.com", "HKT-shop");
